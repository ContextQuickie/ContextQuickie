...
public class PreferenceInitializer extends AbstractPreferenceInitializer {
  ...
  public void initializeDefaultPreferences() {
    ...
    this.getStoreConfigurationItemFromRegistry(store, "HKEY_LOCAL_MACHINE\\SOFTWARE\\TortoiseSVN", "ProcPath",
        "C:\\Program Files\\TortoiseSVN\\bin\\TortoiseProc.exe", PreferenceConstants.P_TORTOISE_SVN_PATH);
    ...
    this.getStoreConfigurationItemFromRegistry(store, "HKEY_LOCAL_MACHINE\\SOFTWARE\\TortoiseSVN", "TMergePath",
        "C:\\Program Files\\TortoiseSVN\\bin\\TortoiseMerge.exe", PreferenceConstants.P_TORTOISE_SVN_MERGE_PATH);
    ...
    store.setDefault(PreferenceConstants.P_TORTOISE_GIT_USE_MENU_CONFIG_FROM_REGISTRY, false);
    ...
    this.getStoreConfigurationItemFromRegistry(store, "HKEY_LOCAL_MACHINE\\SOFTWARE\\TortoiseGit", "ProcPath",
        "C:\\Program Files\\TortoiseGit\\bin\\TortoiseGitProc.exe", PreferenceConstants.P_TORTOISE_GIT_PATH);
    ...
    this.getStoreConfigurationItemFromRegistry(store, "HKEY_LOCAL_MACHINE\\SOFTWARE\\TortoiseGit", "TMergePath",
        "C:\\Program Files\\TortoiseGit\\bin\\TortoiseGitMerge.exe", PreferenceConstants.P_TORTOISE_GIT_MERGE_PATH);

  }

  private void getStoreConfigurationItemFromRegistry(final IPreferenceStore store, final String registryLocation,
      final String registryKey, final String defaultValue, final String configurationItem) {
    // Try to retrieve the path to the Tortoise SVN executable.
